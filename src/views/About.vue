  ...
  <div class="about">
    <section>
      <v-layout align-center text-center column justify-center style="margin-top: 2.5em;">
        ...
        <h3 class="heading mt-6">Турнир Azoft Open 3.0 запущен!</h3>
      ...
      <v-layout align-center column justify-center>
        <v-btn to="/events/open-3" dark large color="#f2c008" class="mt-6">Смотреть таблицу</v-btn>
        ...
        <v-layout align-center column justify-center class="ma-4">
          <v-btn to="/events/open-2" dark small color="#f2c008" class="ma-4">Открытый турнир 2.0</v-btn>
