  ...
  <div class="about">
    <section>
      <v-layout align-center text-center column justify-center style="margin-top: 2.5em;">
        ...
        <h3 class="display-3 ma-2">Azoft Open 1.0</h3>
        <h4 class="subheading">(открытый турнир Azoft по настольному теннису)</h4>
        <ul style="width: 90%; max-width: 500px;" class="mt-6 text-justify">
          <li>Играем в настольный теннис, стол в подвале здания Кутателадзе 4Г, комната №20. Партии до 11 очков, матч до 3 очков (т.е. результат 3:2, 3:1 или 3:0).
            За ходом турнира можно следить в нашем публичном Телеграм канале <a href="tg://join?invite=AAAAAEozhfm_MuI35zUSGA"><strong>azoft_open</strong></a></li>
      ...
      <v-layout align-center column justify-center>
        <v-btn to="/events/open-1" dark large color="#f2c008" class="mt-6">Смотреть таблицу участников</v-btn>
        <v-btn @click="goTg" dark large color="#2483c5" class="my-6">Записаться</v-btn>
        <v-dialog v-model="telegram" max-width="390">
          <v-card>
            <v-card-title class="headline">Телегам чат</v-card-title>
            <v-card-text>
              Установите приложение <a href="https://tlgrm.ru/">Телеграм</a> и найдите в нём канал <strong>azoft_open</strong>. Напишите в него ваше ФИО, сайт вашей компании (прикрутим логотип к вашей фамилии) и TTW рейтинг (если есть). Следите за обновлениями!
            </v-card-text>
            <v-card-actions>
              <v-spacer></v-spacer>
        ...
        <v-flex row wrap text-xs-center class="mb-5">
          Следующий турнир - турнир пар. Тренируйтесь! ;)
        </v-flex>
      </v-layout>
    </section>
  </div>
