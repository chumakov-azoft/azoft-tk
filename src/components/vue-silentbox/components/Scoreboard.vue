<template>
  <div class="scoreboard">
    <div class="team" :class="{win: status === 'win1', lost: status === 'win2'}">
      <div class="chevron" :style="'background-color: ' + videoState.chevrons[0]"></div>
      <div class="rank">{{videoState.ratings[0]}}</div>
      <img class="logo" :src="videoState.logos[0]"/>
    ...
    <div class="team" :class="{win: status === 'win2', lost: status === 'win1'}">
      <div class="chevron" :style="'background-color: ' + videoState.chevrons[1]"></div>
      <div class="rank">{{videoState.ratings[1]}}</div>
      <img class="logo" :src="videoState.logos[1]"/>
